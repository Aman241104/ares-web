          ...
          <div className="glass-card p-10 border-white/10 text-center relative overflow-hidden group hover:border-white/20 transition-colors">
            ...
            <div className="w-32 h-32 rounded-full overflow-hidden mx-auto mb-6 border border-white/20 p-1">
              <div className="w-full h-full rounded-full overflow-hidden relative">
                <Image fill src={team.id === 'modi' ? '/images/owner_modi.png' : team.id === 'doval' ? '/images/owner_doval.png' : team.id === 'amit-shah' ? '/images/owner_shah.png' : '/images/owner-portrait-4.jpg'} alt={team.owner.name} className="object-cover transition-all duration-700" sizes="120px" />
              </div>
            </div>
