...
export default function WebPartnerPage() {
  ...
  return (
    <div ref={containerRef} className="pt-24 bg-[#000000] min-h-screen overflow-x-hidden">
      ...
      {/* ─── PARTNER BADGE ─── */}
      <section className="py-12 px-6 sm:px-10 lg:px-16 bg-[#050505] border-y border-white/5 sr">
      ...
      {/* ─── SERVICES ─── */}
      <section className="py-32 px-6 sm:px-10 lg:px-16 bg-[#000000] sr">
      ...
      {/* ─── WHY WEBHANCE ─── */}
      <section className="py-32 px-6 sm:px-10 lg:px-16 bg-[#050505] border-t border-white/5 sr">
        <div className="max-w-7xl mx-auto">
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-[#000000] border-t border-white/5 sr">
        <div className="max-w-4xl mx-auto text-center">
