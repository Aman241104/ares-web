...
export default function ContactPage() {
  ...
  return (
    <div ref={containerRef} className="pt-24 bg-[#000000] min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sr-stagger">
            {SERVICES.map((s) => (
              <div
                key={s.title}
                className="group relative border border-white/6 hover:border-[rgba(212,175,55,0.25)] bg-[#0B1120] hover:bg-[#030712] transition-all duration-400 p-5 text-center overflow-hidden cursor-default"
              >
                {/* Ghost number */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-5 gap-14">
          ...
          <div className="lg:col-span-2 space-y-5 sr">
            ...
            <div className="space-y-2.5">
              {CONTACT_ITEMS.map((c) => (
                <div key={c.label} className="group relative border border-white/6 bg-[#030712] p-5 hover:border-[rgba(212,175,55,0.2)] transition-all duration-300 overflow-hidden">
                  {/* Gold left accent */}
            ...
            {/* Why us */}
            <div className="relative border border-[rgba(212,175,55,0.15)] bg-[#0B1120] p-6 overflow-hidden">
          ...
          <div className="lg:col-span-3 sr">
            ...
            <div className="relative border border-white/8 bg-[#030712] overflow-hidden">
              {/* Top gold line */}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select required value={form.service}
                        ...
                        <option value="Website Design & Development" className="bg-[#030712]">Website Design & Development</option>
                        <option value="Business Software / ERP" className="bg-[#030712]">Business Software / ERP</option>
                        <option value="Accounting & Billing Software" className="bg-[#030712]">Accounting & Billing Software</option>
                        <option value="Mobile App (iOS & Android)" className="bg-[#030712]">Mobile App (iOS & Android)</option>
                        <option value="CRM & Client Management" className="bg-[#030712]">CRM & Client Management</option>
                        <option value="Custom Software Solution" className="bg-[#030712]">Custom Software Solution</option>
                        <option value="Not Sure — Need Consultation" className="bg-[#030712]">Not Sure — Need Consultation</option>
                      </select>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select value={form.budget}
                        ...
                        className={`${inputCls} appearance-none cursor-pointer pr-12`}>
                        <option value="" className="bg-[#030712]">Select a range (optional)</option>
                        <option value="Under ₹50,000" className="bg-[#030712]">Under ₹50,000</option>
                        <option value="₹50,000 – ₹1,00,000" className="bg-[#030712]">₹50,000 – ₹1,00,000</option>
                        <option value="₹1,00,000 – ₹3,00,000" className="bg-[#030712]">₹1,00,000 – ₹3,00,000</option>
                        <option value="₹3,00,000 – ₹10,00,000" className="bg-[#030712]">₹3,00,000 – ₹10,00,000</option>
                        <option value="Above ₹10,00,000" className="bg-[#030712]">Above ₹10,00,000</option>
                        <option value="Let's Discuss" className="bg-[#030712]">Let's Discuss</option>
                      </select>
                      <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/60 pointer-events-none" />
                    </div>
                  </div>
      ...
      {/* ══════════════ HOW WE WORK ══════════════ */}
      <section className="py-24 px-6 sm:px-10 lg:px-16 bg-[#030712] border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 sr-stagger">
            {PROCESS.map((p, i) => (
              <div key={p.title} className="group relative bg-[#030712] p-10 hover:bg-[#0B1120] transition-all duration-400 overflow-hidden">
