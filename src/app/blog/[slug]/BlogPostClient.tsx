...
export default function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div ref={containerRef} className="pt-24 bg-[#000000] min-h-screen overflow-x-hidden">
      <section className="py-10 sm:py-20 px-6 sm:px-10 lg:px-16 sr">
      ...
      {/* More Posts */}
      <section className="py-12 sm:py-24 px-6 sm:px-10 lg:px-16 bg-[#030712] border-t border-white/5 sr">
