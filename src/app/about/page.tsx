  ...
  return (
    <div ref={containerRef} className="pt-24 bg-[#000000] min-h-screen overflow-x-hidden">
      ...
      <PageHero backgroundImage="/images/hero_trophy_stadium.png" objectPosition="object-[78%_center]" layout="left" className="min-h-[90vh] px-6 sm:px-10 lg:px-16">
        <div className="max-w-7xl mx-auto relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-10 sm:py-20">
          ...
          <div className="h-card lg:col-span-5 lg:col-start-8">
            <div className="relative overflow-hidden border border-[rgba(212,175,55,0.2)] bg-black/50 backdrop-blur-xl rounded-sm p-8 shadow-[0_40px_80px_rgba(0,0,0,0.7)]">
              ...
              <div className="relative w-full h-44 mb-8 overflow-hidden rounded-sm">
                <Image fill src="/images/hero_trophy_stadium.png" alt="Championship Arena" className="object-cover object-[78%_center]" sizes="400px" style={{ filter: "brightness(0.7) contrast(1.1)" }} />
