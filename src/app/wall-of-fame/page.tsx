      ...
      <PageHero layout="left" className="min-h-[70vh]">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full z-10 relative py-24">
          <div className="max-w-2xl">
            ...
            <a href="https://jukeboxmedia.in" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 opacity-85 hover:opacity-100 transition-opacity duration-300">
