...
export default function LiveTicker() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[900] bg-[#0D1424]/80 backdrop-blur-xl px-5 py-4 rounded-xl border border-white/10 flex items-center gap-4 shadow-2xl">
