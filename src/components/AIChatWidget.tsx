...
export default function AIChatWidget() {
  ...
  return (
    <div className="hidden xl:block">
      {!chatOpen && (
        <div className="fixed bottom-9 right-28 z-[998] flex items-center gap-2 bg-[#0B1120] ring-1 ring-[#D4AF37]/30 rounded-full pl-4 pr-5 py-2.5 shadow-[0_10px_30px_rgba(0,0,0,0.4)] animate-[fadeIn_0.6s_ease]">
      ...
      <div
        className={`fixed bottom-24 right-6 z-[999] w-[380px] rounded-2xl overflow-hidden bg-[#0B1120] ring-1 ring-[#D4AF37]/25 shadow-[0_25px_70px_rgba(0,0,0,0.5)] transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] ${
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-[999] w-16 h-16 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#8B6914] ring-1 ring-white/10 shadow-[0_10px_30px_rgba(212,175,55,0.5)] hover:shadow-[0_10px_40px_rgba(212,175,55,0.7)] hover:scale-105 flex items-center justify-center transition-all duration-300"
      >
        {chatOpen ? (
          <X className="w-6 h-6 text-[#050B0A]" strokeWidth={2.25} />
        ) : (
          <>
            <MessageCircle className="w-7 h-7 text-[#050B0A]" strokeWidth={2.25} />
