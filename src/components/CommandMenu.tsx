      ...
      >
        ...
        <Command.List className="max-h-[300px] overflow-y-auto p-2 scrollbar-hide">
          ...
          <Command.Group heading="Quick Links" className="text-[10px] uppercase tracking-widest text-white/40 p-2 font-montserrat mt-2">
            ...
            <Command.Item onSelect={() => { setOpen(false); router.push("/contact") }} className="px-3 py-2 rounded-lg cursor-pointer text-sm text-white/80 hover:bg-white/10 hover:text-white">Build Your Website</Command.Item>
          </Command.Group>
        </Command.List>
      </Command>
